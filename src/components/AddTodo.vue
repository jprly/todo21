<template>
    <Dialog header="Add Todo" :closable="false" :visible="displayBasic" :style="{margin: '20px'}">
             
             <InputText type="text" v-model="todoInput" placeholder="Folder name..." style="width: 100%;"/>
 
             <template #footer>
                 <Button label="Cancel" icon="pi pi-times" @click="methods.toggleAddTodo" class="p-button-text"/>
